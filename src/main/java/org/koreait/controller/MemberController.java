...
public class MemberController extends Controller {
    ...
    public void makeTestData() {
        ...
        members.add(new Member(1, Util.getNow(), "test1", "test1", "검은소"));
        members.add(new Member(2, Util.getNow(), "test2", "test2", "누렁소"));
        members.add(new Member(3, Util.getNow(), "test3", "test3", "하얀소"));
    }
}
